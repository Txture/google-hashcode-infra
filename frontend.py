    ...
    if form.validate_on_submit():
        ...
        for param1 in comb_it1:
            ...
            if comb_it2 is None:
                ...
                process = subprocess.Popen(['python3', 'code/test.py', '--param1', param1])
            else:
                for param2 in comb_it2:
                    ...
                    if comb_it3 is None:
                        ...
                        process = subprocess.Popen(['python3', 'code/test.py', '--param1', param1, '--param2', param2])
                    else:
                        for param3 in comb_it3:
                            ...
                            if comb_it4 is None:
                                ...
                                process = subprocess.Popen(
                                    ['python3', 'code/test.py', '--param1', param1, '--param2', param2, '--param3', param3])
                            else:
                                for param4 in comb_it4:
                                    ...
                                    if comb_it5 is None:
                                        # only start for param1 and param 2
                                        process = subprocess.Popen(
                                            ['python3', 'code/test.py', '--param1', param1, '--param2', param2,
